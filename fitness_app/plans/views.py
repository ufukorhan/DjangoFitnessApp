...
stripe.api_key = "sk_test_51LNbbZAVSXknortbnx1oRSaJsOpBDijq4GedgQ3X7Z9HMAoiITKvEnwxm4NwqOg3jF2A8R6v98qZVj0dA4ziK82Q00Dt1KgSr0"
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        plan = 'price_1LNbq7AVSXknortbcqmwm9iN'
        if request.POST['plan'] == 'yearly':
            plan = 'price_1LNbrZAVSXknortbWcjtFAcZ'
